    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "svelte-kvcgp5");
    			add_location(img0, file$2, 7, 12, 174);
    			attr_dev(a0, "href", "#0");
    			attr_dev(a0, "class", "logo svelte-kvcgp5");
    			...
    			attr_dev(img1, "class", "svelte-kvcgp5");
    			add_location(img1, file$2, 10, 12, 281);
    			attr_dev(a1, "href", "#0");
    			attr_dev(a1, "class", "hamburger svelte-kvcgp5");
    			...
    			attr_dev(img2, "class", "svelte-kvcgp5");
    			add_location(img2, file$2, 13, 12, 407);
    			attr_dev(a2, "href", "#0");
    			attr_dev(a2, "class", "close svelte-kvcgp5");
    			...
    			attr_dev(img3, "class", "svelte-kvcgp5");
    			add_location(img3, file$2, 17, 52, 566);
    			attr_dev(a3, "href", "#0");
    			attr_dev(a3, "class", "svelte-kvcgp5");
    			add_location(a3, file$2, 19, 24, 696);
    			attr_dev(a4, "href", "#0");
    			attr_dev(a4, "class", "svelte-kvcgp5");
    			add_location(a4, file$2, 20, 24, 747);
    			attr_dev(a5, "href", "#0");
    			attr_dev(a5, "class", "svelte-kvcgp5");
    			add_location(a5, file$2, 21, 24, 798);
    			attr_dev(div0, "class", "dropdown-product svelte-kvcgp5");
    			add_location(div0, file$2, 18, 20, 641);
    			attr_dev(a6, "href", "#0");
    			attr_dev(a6, "class", "product svelte-kvcgp5");
    			add_location(a6, file$2, 17, 16, 530);
    			attr_dev(li0, "class", "svelte-kvcgp5");
    			...
    			attr_dev(img4, "class", "svelte-kvcgp5");
    			add_location(img4, file$2, 26, 52, 960);
    			attr_dev(a7, "href", "#0");
    			attr_dev(a7, "class", "svelte-kvcgp5");
    			add_location(a7, file$2, 28, 24, 1090);
    			attr_dev(a8, "href", "#0");
    			attr_dev(a8, "class", "svelte-kvcgp5");
    			add_location(a8, file$2, 29, 24, 1141);
    			attr_dev(a9, "href", "#0");
    			attr_dev(a9, "class", "svelte-kvcgp5");
    			add_location(a9, file$2, 30, 24, 1192);
    			attr_dev(div1, "class", "dropdown-company svelte-kvcgp5");
    			add_location(div1, file$2, 27, 20, 1035);
    			attr_dev(a10, "href", "#0");
    			attr_dev(a10, "class", "company svelte-kvcgp5");
    			add_location(a10, file$2, 26, 16, 924);
    			attr_dev(li1, "class", "svelte-kvcgp5");
    			...
    			attr_dev(img5, "class", "svelte-kvcgp5");
    			add_location(img5, file$2, 35, 52, 1354);
    			attr_dev(a11, "href", "#0");
    			attr_dev(a11, "class", "svelte-kvcgp5");
    			add_location(a11, file$2, 37, 24, 1484);
    			attr_dev(a12, "href", "#0");
    			attr_dev(a12, "class", "svelte-kvcgp5");
    			add_location(a12, file$2, 38, 24, 1533);
    			attr_dev(a13, "href", "#0");
    			attr_dev(a13, "class", "svelte-kvcgp5");
    			add_location(a13, file$2, 39, 24, 1585);
    			attr_dev(div2, "class", "dropdown-connect svelte-kvcgp5");
    			add_location(div2, file$2, 36, 20, 1429);
    			attr_dev(a14, "href", "#0");
    			attr_dev(a14, "class", "connect svelte-kvcgp5");
    			add_location(a14, file$2, 35, 16, 1318);
    			attr_dev(li2, "class", "svelte-kvcgp5");
    			add_location(li2, file$2, 34, 12, 1297);
    			attr_dev(ul, "class", "svelte-kvcgp5");
    			add_location(ul, file$2, 15, 8, 492);
    			attr_dev(a15, "href", "#0");
    			attr_dev(a15, "class", "svelte-kvcgp5");
    			add_location(a15, file$2, 45, 20, 1761);
    			attr_dev(button0, "class", "svelte-kvcgp5");
    			add_location(button0, file$2, 45, 12, 1753);
    			attr_dev(a16, "href", "#0");
    			attr_dev(a16, "class", "svelte-kvcgp5");
    			add_location(a16, file$2, 46, 20, 1813);
    			attr_dev(button1, "class", "svelte-kvcgp5");
    			add_location(button1, file$2, 46, 12, 1805);
    			attr_dev(div3, "class", "btn-nav svelte-kvcgp5");
    			add_location(div3, file$2, 44, 8, 1719);
    			attr_dev(nav, "class", "svelte-kvcgp5");
    			toggle_class(nav, "active", /*active*/ ctx[0]);
    			add_location(nav, file$2, 5, 4, 75);
    			attr_dev(h1, "class", "svelte-kvcgp5");
    			add_location(h1, file$2, 50, 8, 1892);
    			attr_dev(p, "class", "svelte-kvcgp5");
    			add_location(p, file$2, 53, 8, 1960);
    			attr_dev(main, "class", "svelte-kvcgp5");
    			add_location(main, file$2, 49, 4, 1877);
    			attr_dev(a17, "href", "#0");
    			attr_dev(a17, "class", "svelte-kvcgp5");
    			add_location(a17, file$2, 56, 16, 2071);
    			attr_dev(button2, "class", "svelte-kvcgp5");
    			add_location(button2, file$2, 56, 8, 2063);
    			attr_dev(a18, "href", "#0");
    			attr_dev(a18, "class", "svelte-kvcgp5");
    			add_location(a18, file$2, 57, 16, 2128);
    			attr_dev(button3, "class", "svelte-kvcgp5");
    			add_location(button3, file$2, 57, 8, 2120);
    			attr_dev(div4, "class", "btn-botton svelte-kvcgp5");
    			add_location(div4, file$2, 55, 4, 2030);
    			attr_dev(div5, "class", "container svelte-kvcgp5");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h10, "class", "head-line svelte-1dgs1fe");
    			add_location(h10, file$1, 3, 4, 30);
    			attr_dev(h20, "class", "svelte-1dgs1fe");
    			add_location(h20, file$1, 5, 8, 117);
    			attr_dev(p0, "class", "svelte-1dgs1fe");
    			add_location(p0, file$1, 6, 8, 167);
    			attr_dev(div0, "class", "content-1 svelte-1dgs1fe");
    			add_location(div0, file$1, 4, 4, 85);
    			attr_dev(h21, "class", "svelte-1dgs1fe");
    			add_location(h21, file$1, 11, 8, 579);
    			attr_dev(p1, "class", "svelte-1dgs1fe");
    			add_location(p1, file$1, 12, 8, 622);
    			attr_dev(div1, "class", "content-2 svelte-1dgs1fe");
    			...
    			attr_dev(img0, "class", "svelte-1dgs1fe");
    			add_location(img0, file$1, 17, 8, 916);
    			attr_dev(div2, "class", "img-editor svelte-1dgs1fe");
    			add_location(div2, file$1, 16, 4, 883);
    			attr_dev(div3, "class", "infrastructure svelte-1dgs1fe");
    			add_location(div3, file$1, 19, 4, 997);
    			if (img1.src !== (img1_src_value = "./images/illustration-phones.svg")) attr_dev(img1, "src", img1_src_value);
    			attr_dev(img1, "alt", "phones");
    			attr_dev(img1, "class", "svelte-1dgs1fe");
    			add_location(img1, file$1, 21, 8, 1069);
    			attr_dev(div4, "class", "img-phones svelte-1dgs1fe");
    			add_location(div4, file$1, 20, 4, 1036);
    			attr_dev(h11, "class", "svelte-1dgs1fe");
    			add_location(h11, file$1, 24, 8, 1174);
    			attr_dev(p2, "class", "svelte-1dgs1fe");
    			add_location(p2, file$1, 25, 8, 1223);
    			attr_dev(div5, "class", "content-3 svelte-1dgs1fe");
    			add_location(div5, file$1, 23, 4, 1142);
    			...
    			attr_dev(img2, "class", "svelte-1dgs1fe");
    			add_location(img2, file$1, 30, 8, 1522);
    			attr_dev(div6, "class", "img-laptop svelte-1dgs1fe");
    			add_location(div6, file$1, 29, 4, 1489);
    			attr_dev(h22, "class", "svelte-1dgs1fe");
    			add_location(h22, file$1, 33, 8, 1635);
    			attr_dev(p3, "class", "svelte-1dgs1fe");
    			add_location(p3, file$1, 36, 8, 1693);
    			attr_dev(div7, "class", "content-4 svelte-1dgs1fe");
    			add_location(div7, file$1, 32, 4, 1603);
    			attr_dev(h23, "class", "svelte-1dgs1fe");
    			add_location(h23, file$1, 41, 8, 2097);
    			attr_dev(p4, "class", "svelte-1dgs1fe");
    			add_location(p4, file$1, 42, 8, 2131);
    			attr_dev(div8, "class", "content-5 svelte-1dgs1fe");
    			add_location(div8, file$1, 40, 4, 2065);
    			attr_dev(div9, "class", "container svelte-1dgs1fe");
    			add_location(div9, file$1, 2, 0, 2);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
