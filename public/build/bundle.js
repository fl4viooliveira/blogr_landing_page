    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(h10, "class", "head-line svelte-1nbo825");
    			add_location(h10, file$1, 3, 4, 30);
    			attr_dev(h20, "class", "svelte-1nbo825");
    			add_location(h20, file$1, 5, 8, 117);
    			attr_dev(p0, "class", "svelte-1nbo825");
    			add_location(p0, file$1, 6, 8, 167);
    			attr_dev(div0, "class", "content-1 svelte-1nbo825");
    			add_location(div0, file$1, 4, 4, 85);
    			attr_dev(h21, "class", "svelte-1nbo825");
    			add_location(h21, file$1, 11, 8, 579);
    			attr_dev(p1, "class", "svelte-1nbo825");
    			add_location(p1, file$1, 12, 8, 622);
    			attr_dev(div1, "class", "content-2 svelte-1nbo825");
    			add_location(div1, file$1, 10, 4, 547);
    			attr_dev(img0, "class", "img-editor svelte-1nbo825");
    			...
    			attr_dev(div2, "class", "infrastructure svelte-1nbo825");
    			...
    			attr_dev(img1, "class", "svelte-1nbo825");
    			add_location(img1, file$1, 20, 8, 1139);
    			attr_dev(div3, "class", "img-phones svelte-1nbo825");
    			add_location(div3, file$1, 19, 4, 1106);
    			attr_dev(h11, "class", "svelte-1nbo825");
    			add_location(h11, file$1, 23, 8, 1244);
    			attr_dev(p2, "class", "svelte-1nbo825");
    			add_location(p2, file$1, 24, 8, 1293);
    			attr_dev(div4, "class", "content-3 svelte-1nbo825");
    			add_location(div4, file$1, 22, 4, 1212);
    			attr_dev(img2, "class", "img-laptop svelte-1nbo825");
    			...
    			attr_dev(h22, "class", "svelte-1nbo825");
    			add_location(h22, file$1, 30, 8, 1677);
    			attr_dev(p3, "class", "svelte-1nbo825");
    			add_location(p3, file$1, 33, 8, 1735);
    			attr_dev(div5, "class", "content-4 svelte-1nbo825");
    			add_location(div5, file$1, 29, 4, 1645);
    			attr_dev(h23, "class", "svelte-1nbo825");
    			add_location(h23, file$1, 38, 8, 2139);
    			attr_dev(p4, "class", "svelte-1nbo825");
    			add_location(p4, file$1, 39, 8, 2173);
    			attr_dev(div6, "class", "content-5 svelte-1nbo825");
    			add_location(div6, file$1, 37, 4, 2107);
    			attr_dev(div7, "class", "container svelte-1nbo825");
