    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "svelte-ydkae4");
    			add_location(img0, file$3, 7, 12, 174);
    			attr_dev(a0, "href", "#0");
    			attr_dev(a0, "class", "logo svelte-ydkae4");
    			...
    			attr_dev(img1, "class", "svelte-ydkae4");
    			add_location(img1, file$3, 10, 12, 281);
    			attr_dev(a1, "href", "#0");
    			attr_dev(a1, "class", "hamburger svelte-ydkae4");
    			...
    			attr_dev(img2, "class", "svelte-ydkae4");
    			add_location(img2, file$3, 13, 12, 407);
    			attr_dev(a2, "href", "#0");
    			attr_dev(a2, "class", "close svelte-ydkae4");
    			...
    			attr_dev(img3, "class", "arrow-light svelte-ydkae4");
    			...
    			attr_dev(img4, "class", "arrow-dark svelte-ydkae4");
    			add_location(img4, file$3, 20, 20, 703);
    			attr_dev(a3, "href", "#0");
    			attr_dev(a3, "class", "svelte-ydkae4");
    			add_location(a3, file$3, 22, 24, 851);
    			attr_dev(a4, "href", "#0");
    			attr_dev(a4, "class", "svelte-ydkae4");
    			add_location(a4, file$3, 23, 24, 901);
    			attr_dev(a5, "href", "#0");
    			attr_dev(a5, "class", "svelte-ydkae4");
    			add_location(a5, file$3, 24, 24, 950);
    			attr_dev(a6, "href", "#0");
    			attr_dev(a6, "class", "svelte-ydkae4");
    			add_location(a6, file$3, 25, 24, 1003);
    			attr_dev(a7, "href", "#0");
    			attr_dev(a7, "class", "svelte-ydkae4");
    			add_location(a7, file$3, 26, 24, 1053);
    			attr_dev(div0, "class", "dropdown-product svelte-ydkae4");
    			add_location(div0, file$3, 21, 20, 796);
    			attr_dev(a8, "href", "#0");
    			attr_dev(a8, "class", "product svelte-ydkae4");
    			add_location(a8, file$3, 17, 16, 530);
    			attr_dev(li0, "class", "svelte-ydkae4");
    			add_location(li0, file$3, 16, 12, 509);
    			if (img5.src !== (img5_src_value = "../images/icon-arrow-light.svg")) attr_dev(img5, "src", img5_src_value);
    			attr_dev(img5, "alt", "arrow");
    			attr_dev(img5, "class", "arrow-light svelte-ydkae4");
    			add_location(img5, file$3, 33, 20, 1284);
    			if (img6.src !== (img6_src_value = "../images/icon-arrow-dark.svg")) attr_dev(img6, "src", img6_src_value);
    			attr_dev(img6, "alt", "arrow");
    			attr_dev(img6, "class", "arrow-dark svelte-ydkae4");
    			add_location(img6, file$3, 34, 20, 1379);
    			attr_dev(a9, "href", "#0");
    			attr_dev(a9, "class", "svelte-ydkae4");
    			add_location(a9, file$3, 36, 24, 1527);
    			attr_dev(a10, "href", "#0");
    			attr_dev(a10, "class", "svelte-ydkae4");
    			add_location(a10, file$3, 37, 24, 1574);
    			attr_dev(a11, "href", "#0");
    			attr_dev(a11, "class", "svelte-ydkae4");
    			add_location(a11, file$3, 38, 24, 1620);
    			attr_dev(a12, "href", "#0");
    			attr_dev(a12, "class", "svelte-ydkae4");
    			add_location(a12, file$3, 39, 24, 1666);
    			attr_dev(div1, "class", "dropdown-company svelte-ydkae4");
    			add_location(div1, file$3, 35, 20, 1472);
    			attr_dev(a13, "href", "#0");
    			attr_dev(a13, "class", "company svelte-ydkae4");
    			add_location(a13, file$3, 31, 16, 1206);
    			attr_dev(li1, "class", "svelte-ydkae4");
    			add_location(li1, file$3, 30, 12, 1185);
    			if (img7.src !== (img7_src_value = "../images/icon-arrow-light.svg")) attr_dev(img7, "src", img7_src_value);
    			attr_dev(img7, "alt", "arrow");
    			attr_dev(img7, "class", "arrow-light svelte-ydkae4");
    			add_location(img7, file$3, 46, 20, 1868);
    			if (img8.src !== (img8_src_value = "../images/icon-arrow-dark.svg")) attr_dev(img8, "src", img8_src_value);
    			attr_dev(img8, "alt", "arrow");
    			attr_dev(img8, "class", "arrow-dark svelte-ydkae4");
    			add_location(img8, file$3, 47, 20, 1963);
    			attr_dev(a14, "href", "#0");
    			attr_dev(a14, "class", "svelte-ydkae4");
    			add_location(a14, file$3, 49, 24, 2111);
    			attr_dev(a15, "href", "#0");
    			attr_dev(a15, "class", "svelte-ydkae4");
    			add_location(a15, file$3, 50, 24, 2160);
    			attr_dev(a16, "href", "#0");
    			attr_dev(a16, "class", "svelte-ydkae4");
    			add_location(a16, file$3, 51, 24, 2212);
    			attr_dev(div2, "class", "dropdown-connect svelte-ydkae4");
    			add_location(div2, file$3, 48, 20, 2056);
    			attr_dev(a17, "href", "#0");
    			attr_dev(a17, "class", "connect svelte-ydkae4");
    			add_location(a17, file$3, 44, 16, 1790);
    			attr_dev(li2, "class", "svelte-ydkae4");
    			add_location(li2, file$3, 43, 12, 1769);
    			attr_dev(ul, "class", "svelte-ydkae4");
    			add_location(ul, file$3, 15, 8, 492);
    			attr_dev(a18, "href", "#0");
    			attr_dev(a18, "class", "svelte-ydkae4");
    			add_location(a18, file$3, 57, 20, 2388);
    			attr_dev(button0, "class", "svelte-ydkae4");
    			add_location(button0, file$3, 57, 12, 2380);
    			attr_dev(a19, "href", "#0");
    			attr_dev(a19, "class", "svelte-ydkae4");
    			add_location(a19, file$3, 58, 20, 2440);
    			attr_dev(button1, "class", "svelte-ydkae4");
    			add_location(button1, file$3, 58, 12, 2432);
    			attr_dev(div3, "class", "btn-nav svelte-ydkae4");
    			add_location(div3, file$3, 56, 8, 2346);
    			attr_dev(nav, "class", "svelte-ydkae4");
    			toggle_class(nav, "active", /*active*/ ctx[0]);
    			add_location(nav, file$3, 5, 4, 75);
    			attr_dev(h1, "class", "svelte-ydkae4");
    			add_location(h1, file$3, 62, 8, 2519);
    			attr_dev(p, "class", "svelte-ydkae4");
    			add_location(p, file$3, 65, 8, 2587);
    			attr_dev(main, "class", "svelte-ydkae4");
    			add_location(main, file$3, 61, 4, 2504);
    			attr_dev(a20, "href", "#0");
    			attr_dev(a20, "class", "svelte-ydkae4");
    			add_location(a20, file$3, 68, 16, 2698);
    			attr_dev(button2, "class", "svelte-ydkae4");
    			add_location(button2, file$3, 68, 8, 2690);
    			attr_dev(a21, "href", "#0");
    			attr_dev(a21, "class", "svelte-ydkae4");
    			add_location(a21, file$3, 69, 16, 2755);
    			attr_dev(button3, "class", "svelte-ydkae4");
    			add_location(button3, file$3, 69, 8, 2747);
    			attr_dev(div4, "class", "btn-botton svelte-ydkae4");
    			add_location(div4, file$3, 67, 4, 2657);
    			attr_dev(div5, "class", "container svelte-ydkae4");
