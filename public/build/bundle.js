    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img0, "class", "svelte-1u01k8");
    			add_location(img0, file$1, 7, 12, 174);
    			attr_dev(a0, "href", "#0");
    			attr_dev(a0, "class", "logo svelte-1u01k8");
    			...
    			attr_dev(img1, "class", "svelte-1u01k8");
    			add_location(img1, file$1, 10, 12, 281);
    			attr_dev(a1, "href", "#0");
    			attr_dev(a1, "class", "hamburger svelte-1u01k8");
    			...
    			attr_dev(img2, "class", "svelte-1u01k8");
    			add_location(img2, file$1, 13, 12, 407);
    			attr_dev(a2, "href", "#0");
    			attr_dev(a2, "class", "close svelte-1u01k8");
    			...
    			attr_dev(img3, "class", "svelte-1u01k8");
    			add_location(img3, file$1, 17, 52, 566);
    			attr_dev(a3, "href", "#0");
    			attr_dev(a3, "class", "svelte-1u01k8");
    			add_location(a3, file$1, 19, 24, 696);
    			attr_dev(a4, "href", "#0");
    			attr_dev(a4, "class", "svelte-1u01k8");
    			add_location(a4, file$1, 20, 24, 747);
    			attr_dev(a5, "href", "#0");
    			attr_dev(a5, "class", "svelte-1u01k8");
    			add_location(a5, file$1, 21, 24, 798);
    			attr_dev(div0, "class", "dropdown-product svelte-1u01k8");
    			add_location(div0, file$1, 18, 20, 641);
    			attr_dev(a6, "href", "#0");
    			attr_dev(a6, "class", "product svelte-1u01k8");
    			add_location(a6, file$1, 17, 16, 530);
    			attr_dev(li0, "class", "svelte-1u01k8");
    			...
    			attr_dev(img4, "class", "svelte-1u01k8");
    			add_location(img4, file$1, 26, 52, 960);
    			attr_dev(a7, "href", "#0");
    			attr_dev(a7, "class", "svelte-1u01k8");
    			add_location(a7, file$1, 28, 24, 1090);
    			attr_dev(a8, "href", "#0");
    			attr_dev(a8, "class", "svelte-1u01k8");
    			add_location(a8, file$1, 29, 24, 1141);
    			attr_dev(a9, "href", "#0");
    			attr_dev(a9, "class", "svelte-1u01k8");
    			add_location(a9, file$1, 30, 24, 1192);
    			attr_dev(div1, "class", "dropdown-company svelte-1u01k8");
    			add_location(div1, file$1, 27, 20, 1035);
    			attr_dev(a10, "href", "#0");
    			attr_dev(a10, "class", "company svelte-1u01k8");
    			add_location(a10, file$1, 26, 16, 924);
    			attr_dev(li1, "class", "svelte-1u01k8");
    			...
    			attr_dev(img5, "class", "svelte-1u01k8");
    			add_location(img5, file$1, 35, 52, 1354);
    			attr_dev(a11, "href", "#0");
    			attr_dev(a11, "class", "svelte-1u01k8");
    			add_location(a11, file$1, 37, 24, 1484);
    			attr_dev(a12, "href", "#0");
    			attr_dev(a12, "class", "svelte-1u01k8");
    			add_location(a12, file$1, 38, 24, 1533);
    			attr_dev(a13, "href", "#0");
    			attr_dev(a13, "class", "svelte-1u01k8");
    			add_location(a13, file$1, 39, 24, 1585);
    			attr_dev(div2, "class", "dropdown-connect svelte-1u01k8");
    			add_location(div2, file$1, 36, 20, 1429);
    			attr_dev(a14, "href", "#0");
    			attr_dev(a14, "class", "connect svelte-1u01k8");
    			add_location(a14, file$1, 35, 16, 1318);
    			attr_dev(li2, "class", "svelte-1u01k8");
    			add_location(li2, file$1, 34, 12, 1297);
    			attr_dev(ul, "class", "svelte-1u01k8");
    			add_location(ul, file$1, 15, 8, 492);
    			attr_dev(a15, "href", "#0");
    			attr_dev(a15, "class", "svelte-1u01k8");
    			add_location(a15, file$1, 45, 20, 1761);
    			attr_dev(button0, "class", "svelte-1u01k8");
    			add_location(button0, file$1, 45, 12, 1753);
    			attr_dev(a16, "href", "#0");
    			attr_dev(a16, "class", "svelte-1u01k8");
    			add_location(a16, file$1, 46, 20, 1813);
    			attr_dev(button1, "class", "svelte-1u01k8");
    			add_location(button1, file$1, 46, 12, 1805);
    			attr_dev(div3, "class", "btn-nav svelte-1u01k8");
    			add_location(div3, file$1, 44, 8, 1719);
    			attr_dev(nav, "class", "svelte-1u01k8");
    			toggle_class(nav, "active", /*active*/ ctx[0]);
    			add_location(nav, file$1, 5, 4, 75);
    			attr_dev(h1, "class", "svelte-1u01k8");
    			add_location(h1, file$1, 50, 8, 1892);
    			attr_dev(p, "class", "svelte-1u01k8");
    			add_location(p, file$1, 53, 8, 1960);
    			attr_dev(main, "class", "svelte-1u01k8");
    			add_location(main, file$1, 49, 4, 1877);
    			attr_dev(a17, "href", "#0");
    			attr_dev(a17, "class", "svelte-1u01k8");
    			add_location(a17, file$1, 56, 16, 2071);
    			attr_dev(button2, "class", "svelte-1u01k8");
    			add_location(button2, file$1, 56, 8, 2063);
    			attr_dev(a18, "href", "#0");
    			attr_dev(a18, "class", "svelte-1u01k8");
    			add_location(a18, file$1, 57, 16, 2128);
    			attr_dev(button3, "class", "svelte-1u01k8");
    			add_location(button3, file$1, 57, 8, 2120);
    			attr_dev(div4, "class", "btn-botton svelte-1u01k8");
    			add_location(div4, file$1, 55, 4, 2030);
    			attr_dev(div5, "class", "container svelte-1u01k8");
